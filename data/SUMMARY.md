...
[`compromised-packages.txt`](compromised-packages.txt) · 
[Atom feed](feed.atom)

## npm

| Package | Versions | Severity | First seen | Sources |
|---|---|---|---|---|
| `@cap-js/db-service` | `= 2.10.1` | critical | 2026-05-20 | GHSA: GHSA-pvw4-cvr4-97p8 |
| `@cap-js/postgres` | `= 2.2.2` | critical | 2026-05-20 | GHSA: GHSA-pvw4-cvr4-97p8 |
| `@cap-js/sqlite` | `= 2.2.2` | critical | 2026-05-20 | GHSA: GHSA-pvw4-cvr4-97p8 |
| `@mistralai/mistralai` | `2.2.3`<br>`2.2.4`<br>`2.2.2` | critical | 2026-05-11 | TheHackerNews, OSV: MAL-2026-3432 |
